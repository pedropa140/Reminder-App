...
import { updateUserInfo, sendFeedback } from "../api";
    ...
    <div className={darkMode ? "app dark-mode" : "app"}>
      <nav className='navbar'>
        ...
        <ul className='nav-links'>
          ...
          <li>
            <Link to='/user/goal'>TASKS</Link>
          </li>
          <li>
            <Link to='/user/pair'>PAIR</Link>
          </li>
          <li>
            <Link to='/user/calendar'>CALENDAR</Link>
          </li>
          <li>
            <Link to='/user/pomodoro'>POMODORO TIMER</Link>
          </li>
          <li>
            <Link to='/user/chatbot'>CHATBOT</Link>
          </li>
          <li>
      ...
      <Container maxWidth='xs'>
        ...
        >
          <Typography
            variant='h4'
            sx={{ mb: 2, color: darkMode ? "white" : "text.primary" }}
          >
            Contact Us
          </Typography>
          <form
